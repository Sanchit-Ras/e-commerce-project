...
function ProductDetail({ onCartChange }) {
  ...
  return (
    ...
    <div className='flex w-full justify-center items-center '>
      ...
      <div className="flex flex-col md:flex-row py-4 px-8 my-4 bg-white gap-10 w-full max-w-7xl h-full relative">{/*w-full and max-w-7xl - This will force the container to expand to the full width of its parent, but it will still be constrained by max-w-7xl*/}
        ...
        <div className='md:min-w-[50%] overflow-hidden'>
          <img className="w-full object-cover transition-transform duration-300 ease-in-out hover:scale-150 md:max-h-96"
        ...
        <div className='flex flex-col gap-4'>
          ...
          <div>
            <input type="number" value={quantity} min="1" onChange={handelQuantity} className='w-15 p-1.5 text-center border mr-1 md:text-xl' />
